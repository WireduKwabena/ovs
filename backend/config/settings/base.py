...
BACKGROUND_CHECK_HTTP_MAX_RETRIES = config("BACKGROUND_CHECK_HTTP_MAX_RETRIES", default=2, cast=int)
BACKGROUND_CHECK_HTTP_RETRY_BACKOFF_SECONDS = config(
    "BACKGROUND_CHECK_HTTP_RETRY_BACKOFF_SECONDS",
    default=0.75,
    cast=float,
)
BACKGROUND_CHECK_MAX_PAYLOAD_BYTES = config("BACKGROUND_CHECK_MAX_PAYLOAD_BYTES", default=1048576, cast=int)
BACKGROUND_CHECK_WEBHOOK_PROVIDER_TOKENS = config("BACKGROUND_CHECK_WEBHOOK_PROVIDER_TOKENS", default="")
BACKGROUND_CHECK_WEBHOOK_PROVIDER_SECRETS = config("BACKGROUND_CHECK_WEBHOOK_PROVIDER_SECRETS", default="")
BACKGROUND_CHECK_WEBHOOK_REQUIRE_SIGNATURE = config(
    "BACKGROUND_CHECK_WEBHOOK_REQUIRE_SIGNATURE",
    default=False,
    cast=bool,
)
BACKGROUND_CHECK_WEBHOOK_ACK_DEAD_LETTER = config(
    "BACKGROUND_CHECK_WEBHOOK_ACK_DEAD_LETTER",
    default=True,
    cast=bool,
)
BACKGROUND_CHECK_WEBHOOK_THROTTLE_RATE = config("BACKGROUND_CHECK_WEBHOOK_THROTTLE_RATE", default="120/hour")
BACKGROUND_CHECK_WEBHOOK_RETENTION_DAYS = config(
    "BACKGROUND_CHECK_WEBHOOK_RETENTION_DAYS",
    default=90,
    cast=int,
)
BACKGROUND_CHECK_SWEEP_MAX_AGE_HOURS = config("BACKGROUND_CHECK_SWEEP_MAX_AGE_HOURS", default=48, cast=int)
BACKGROUND_CHECK_SWEEP_MIN_POLL_INTERVAL_MINUTES = config(
    "BACKGROUND_CHECK_SWEEP_MIN_POLL_INTERVAL_MINUTES",
    default=15,
    cast=int,
)
