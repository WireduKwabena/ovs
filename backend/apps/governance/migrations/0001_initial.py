...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "ordering": ["name"],
                "indexes": [models.Index(fields=["is_active", "name"], name="governance__is_acti_e916b0_idx")],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["organization", "is_active"], name="governance__organiz_3e6f21_idx"),
                ],
                "constraints": [
                    models.UniqueConstraint(fields=("user", "organization"), name="uniq_org_membership_user_org"),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["organization", "is_active"], name="governance__organiz_b3b142_idx"),
                    models.Index(fields=["committee_type", "is_active"], name="governance__committ_b00c7f_idx"),
                ],
                "constraints": [
                    models.UniqueConstraint(fields=("organization", "code"), name="uniq_committee_org_code"),
                    models.UniqueConstraint(fields=("organization", "name"), name="uniq_committee_org_name"),
                ],
            },
        ),
        migrations.CreateModel(
