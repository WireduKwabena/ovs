...
class VideoMeeting(models.Model):
    ...
    reminder_before_failure_count = models.PositiveSmallIntegerField(default=0)
    reminder_before_last_failure_at = models.DateTimeField(null=True, blank=True)
    reminder_before_next_retry_at = models.DateTimeField(null=True, blank=True, db_index=True)
    reminder_start_sent_at = models.DateTimeField(null=True, blank=True)
    reminder_start_failure_count = models.PositiveSmallIntegerField(default=0)
    reminder_start_last_failure_at = models.DateTimeField(null=True, blank=True)
    reminder_start_next_retry_at = models.DateTimeField(null=True, blank=True, db_index=True)
    reminder_time_up_sent_at = models.DateTimeField(null=True, blank=True)
    reminder_time_up_failure_count = models.PositiveSmallIntegerField(default=0)
    reminder_time_up_last_failure_at = models.DateTimeField(null=True, blank=True)
    reminder_time_up_next_retry_at = models.DateTimeField(null=True, blank=True, db_index=True)
