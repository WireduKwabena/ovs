...
from apps.authentication.serializers import (
    ...
    TwoFactorVerificationSerializer, TwoFactorEnableRequestSerializer, LogoutRequestSerializer,
    UserAuthResponseSerializer, AdminAuthResponseSerializer, RegisterResponseSerializer,
    TwoFactorChallengeSerializer, MessageResponseSerializer, ErrorResponseSerializer,
    TwoFactorSetupResponseSerializer, ProfileResponseSerializer,
)
import logging
...
@extend_schema(request=LoginSerializer, responses={200: UserAuthResponseSerializer, 400: ErrorResponseSerializer})
@api_view(['POST'])
@permission_classes([AllowAny])
...
@extend_schema(
    ...
    responses={200: AdminAuthResponseSerializer, 400: ErrorResponseSerializer},
)
@api_view(['POST'])
@permission_classes([AllowAny])
