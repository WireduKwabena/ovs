...
export const OrgAdminLayout: React.FC<OrgAdminLayoutProps> = ({ children }) => {
  ...
  const navItems = activeOrganizationId
    ? [
        {
          to: getOrgAdminPath(activeOrganizationId, "dashboard"),
          label: "Org Dashboard",
          icon: LayoutDashboard,
        },
        {
          to: getOrgAdminPath(activeOrganizationId, "cases"),
          label: "Vetting Cases",
          icon: FolderOpen,
        },
        {
          to: getOrgAdminPath(activeOrganizationId, "committees"),
          label: "Committees",
          icon: Users,
        },
        {
          to: getOrgAdminPath(activeOrganizationId, "members"),
          label: "Members",
          icon: UserPlus,
        },
        {
          to: getOrgAdminPath(activeOrganizationId, "onboarding"),
          label: "Onboarding",
          icon: ClipboardCheck,
        },
