...
const OrgDashboardPage: React.FC = () => {
  ...
  const pipelineData = dashboardStats
    ? [
        ...
        {
          name: "Under Review",
          value: dashboardStats.under_review,
          status: "under_review",
        },
        {
          name: "Approved",
  ...
  const recentActions = (dashboardStats?.recent_applications ?? [])
    .slice(0, 5)
    .map((app) => ({
      action:
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[40vh] space-y-4 text-center p-8">
        ...
        <p className="text-muted-foreground max-w-md">
          Please select an active organization to access the organization
  ...
  return (
    <div className="space-y-8 px-4 md:px-8 lg:px-12 pb-6 md:pb-8 lg:pb-10">
      {/* Org Header */}
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm md:text-base">
            Operational oversight of your organization&apos;s vetting pipeline
        ...
        <Card className="p-5 rounded-2xl border-border/70 bg-card/50 shadow-sm backdrop-blur-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                {summary?.stats.members_active ?? 0}
              </p>
            </div>
          </div>
        </Card>
        <Card className="p-5 rounded-2xl border-border/70 bg-card/50 shadow-sm backdrop-blur-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                {summary?.stats.committees_active ?? 0}
              </p>
            </div>
          </div>
        </Card>
            ...
            <Card className="p-6 rounded-4xl border-border/70 bg-card/50 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(`/admin/org/${activeOrganizationId}/committees`)
                  }
                >
                  Manage Hub
                </Button>
            ...
            <Card className="p-6 rounded-4xl border-border/70 bg-card/50 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(`/admin/org/${activeOrganizationId}/onboarding`)
                  }
                >
                  Manage Onboarding
                </Button>
              ...
              {onboarding?.token && (
                <div className="space-y-2 mt-2">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-bold">
                      {onboarding.organization_seat_remaining ?? 0} /{" "}
                      {onboarding.organization_seat_limit ?? 0}
                    </span>
                  </div>
                </div>
              )}
          ...
          <Card className="p-6 rounded-[2.5rem] border-border/70 bg-primary text-white shadow-xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-primary-foreground/80 mb-6 leading-relaxed">
                Orchestrate your organization&apos;s vetting pipeline and
                personnel roles.
              </p>
              <div className="space-y-2">
                <button
                  onClick={() =>
                    navigate(`/admin/org/${activeOrganizationId}/cases`)
                  }
