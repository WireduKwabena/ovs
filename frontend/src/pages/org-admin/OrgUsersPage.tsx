...
const OrgUsersPage: React.FC = () => {
  ...
  const [userTypeFilter, setUserTypeFilter] = useState(() => searchParams.get("user_type") || "");
  const [isActiveFilter, setIsActiveFilter] = useState(() => {
    const v = searchParams.get("is_active");
    return v === "true" ? "true" : v === "false" ? "false" : "";
  });

  const hasActiveFilters = Boolean(searchFilter || userTypeFilter || isActiveFilter !== "");
  ...
  const fetchUsers = useCallback(
    async (isSilent = false) => {
      ...
      try {
        ...
        const response = await adminService.getOrgUsers(organizationId, {
          q: searchFilter || undefined,
          user_type: (userTypeFilter as "admin" | "internal" | "applicant") || undefined,
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 self-end md:self-center">
                  ...
                  >
                    ...
                    {updatingId === u.id ? "Updating..." : u.is_active ? "Suspend" : "Activate"}
                  </Button>
