      ...
      <form className="space-y-3" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="submit"
            disabled={disabled}
            className="inline-flex items-center rounded-lg bg-slate-300 px-4 py-2 text-sm font-medium text-slate-800 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
          >
            Apply filters
          </button>
          <button
        ...
        <section className="rounded-xl border border-gray-200 bg-white p-4">
          {filteredNotifications.length === 0 ? (
            <div className="text-center py-12 space-y-2">
              ...
              {appliedSubsystem === "billing" && (
                <p className="text-sm text-slate-600 max-w-md mx-auto">
                  {appliedEventType === "billing_payment_failed"
                    ? "No payment failure events have been recorded yet. This trace will populate if a payment failure webhook fires during subscription processing."
                    : appliedEventType === "processing_error"
                      ? "No billing processing errors have been recorded yet. This trace will populate if a webhook processing error occurs."
