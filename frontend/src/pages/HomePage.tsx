...
export const HomePage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description:
        "Advanced machine learning algorithms verify document authenticity with 95%+ accuracy",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      ...
      description:
        "Upload and verify multiple document types including IDs, certificates, and credentials",
    ...
    },
    {
      ...
      description:
        "Get verification results in minutes, not days. Automated workflows speed up the process",
    ...
    },
    {
      ...
      description:
        "Bank-level encryption and GDPR-compliant data handling ensure your information is safe",
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description:
        "Upload your documents and fill out the required information",
    },
    {
      step: "3",
      title: "AI Verification",
      description:
        "Our AI system analyzes and verifies your documents automatically",
    },
    {
      step: "4",
      title: "Get Results",
      description:
        "Receive your verification results and proceed with confidence",
    },
  ];

  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
      {/* Navigation: only shown to unauthenticated visitors — authenticated users get the global Navbar from App.tsx */}
      {!isAuthenticated && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Streamline your background checks and credential verification with
              cutting-edge artificial intelligence. Fast, accurate, and secure.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Built with the latest technology to provide the most reliable
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">
                AI-powered document verification and background checking
                platform.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
            <p>
              &copy; {new Date().getFullYear()} VettingSystem. All rights
              reserved.
            </p>
          </div>
        </div>
