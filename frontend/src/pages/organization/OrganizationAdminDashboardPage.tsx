...
const OrganizationDashboardPage: React.FC = () => {
  ...
  const nextStep = useMemo(() => {
    ...
    return {
      label: "Configure committee review and approval routing",
      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-10 sm:px-6 lg:px-6 xl:px-8">
        <section className="w-full max-w-xl rounded-2xl border border-amber-200 bg-white p-8 shadow-sm text-center">
          ...
          <p className="mt-3 text-sm text-slate-700">
            Organization governance workspace is available to organization admins.
          </p>
          <div className="mt-6">
      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-10 sm:px-6 lg:px-6 xl:px-8">
        <section className="w-full max-w-xl rounded-2xl border border-amber-200 bg-white p-8 shadow-sm text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <Button type="button" variant="outline" onClick={() => navigate("/workspace")}>
              Back
            </Button>
          </div>
        </section>
  ...
  return (
    <main className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 lg:px-6 xl:px-8">
      <header className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-900">Dashboard</h1>
      ...
      <section className="rounded-xl border border-cyan-200 bg-cyan-50 p-4">
        <p className="text-xs font-semibold uppercase tracking-wide text-cyan-900">Office-Centered Lifecycle</p>
        <p className="mt-2 text-sm text-cyan-900">
          Office -&gt; Appointment Exercise -&gt; Nominee -&gt; Vetting -&gt; Review -&gt; Approval -&gt; Appointment -&gt; Publication
        </p>
      </section>
        ...
        <>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-700">
                Keep the governance flow moving in office-first order by completing the recommended next action.
              </p>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <p className="text-xs text-slate-700">Update organization membership roles and active state.</p>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <p className="text-xs text-slate-700">Create review committees and assign governance structure.</p>
            </button>
            <button
              type="button"
