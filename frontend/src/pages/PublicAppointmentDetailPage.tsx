    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border bg-background">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3 px-4 py-4 sm:px-6 lg:px-8">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-primary">Published Appointment</p>
            <h1 className="text-2xl font-bold text-foreground">Public Appointment Detail</h1>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              to={transparencyHref}
              className="inline-flex items-center gap-2 rounded-md border border-border bg-transparent px-3 py-2 text-sm font-medium text-foreground hover:bg-muted"
            >
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50 p-6">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <Link
                to={transparencyHref}
                className="inline-flex rounded-md border border-border bg-transparent px-3 py-2 text-sm font-semibold text-foreground hover:bg-muted"
              >
          ...
          <div className="space-y-6">
            ...
            <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide text-primary">Published Office Record</p>
                  <h2 className="mt-1 text-3xl font-black text-foreground">{record.position_title}</h2>
                  <p className="mt-2 text-sm text-muted-foreground">{record.institution}</p>
                </div>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <article className="rounded-lg border border-border bg-muted/50 p-4">
                  ...
                  <h3 className="font-semibold text-foreground">Nominee</h3>
                  <p className="mt-2 text-sm text-muted-foreground">{record.nominee_name}</p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">Nominated by:</span> {record.nominated_by_display}
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">Organization:</span> {record.nominated_by_org || "Not specified"}
                  </p>
                </article>
                <article className="rounded-lg border border-border bg-muted/50 p-4">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">Publication reference:</span> {record.publication_reference || "Not provided"}
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">Gazette number:</span> {record.gazette_number || "Pending"}
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">Published at:</span> {formatPublicDate(record.published_at)}
                  </p>
                </article>
              </div>
            </section>
            ...
            <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-border bg-muted/50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Nomination date</p>
                  <p className="mt-2 text-sm text-foreground">{formatPublicDate(record.nomination_date || null)}</p>
                </div>
                <div className="rounded-lg border border-border bg-muted/50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Appointment date</p>
                  <p className="mt-2 text-sm text-foreground">{formatPublicDate(record.appointment_date)}</p>
                </div>
                <div className="rounded-lg border border-border bg-muted/50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Gazette date</p>
                  <p className="mt-2 text-sm text-foreground">{formatPublicDate(record.gazette_date)}</p>
                </div>
                <div className="rounded-lg border border-border bg-muted/50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Publication status</p>
                  <p className="mt-2 text-sm text-foreground">{record.publication_status}</p>
                </div>
              </div>
            </section>
          </div>
