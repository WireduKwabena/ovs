      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Track and manage your vetting applications</p>
          </div>
          <Button asChild>
            <Link
              to="/applications/new"
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-600">{application.application_type}</p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-medium">{formatDate(application.created_at)}</span>
                  </div>
                  <div>
                ...
                {application.notes && (
                  <p className="mt-4 text-gray-700 text-sm line-clamp-2">{application.notes}</p>
                )}
              </Link>
            ))}
          </div>
