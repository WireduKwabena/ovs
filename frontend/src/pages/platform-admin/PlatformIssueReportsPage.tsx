...
const PlatformIssueReportsPage: React.FC = () => {
  ...
  const isAdminOrStaff = Boolean(
    user?.user_type === "platform_admin" || user?.is_staff
  );
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            {isAdminOrStaff && " You can also review and triage submitted reports below."}
          </p>
        </div>
      </div>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        {!isAdminOrStaff ? (
          <p className="text-sm text-slate-600">
            Only platform admins and dev team members can review submitted issue reports here.
          </p>
        ) : loading ? (
